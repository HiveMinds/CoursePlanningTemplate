	...
	Select case fileName
		...
		case "oldExams.csv"
			For i = 0 To lines.count -1
				...
				'0		1	2		3				4			5		6		7	  	 	8
				commands.add("task add due:"+lines.Item(i)(8)+ " priority:M"+" proj:"+twProjectCode+".OldEx"+" "+lines.Item(i)(0)+" exam nr="+lines.Item(i)(1)+" exam date="+lines.Item(i)(2)+" exercise "+lines.Item(i)(3)+"-"+lines.Item(i)(4)+" weight="+lines.Item(i)(5)+" topic="+lines.Item(i)(6)+" lect.topic="+lines.Item(i)(7))'msgbox(commands(i))
			Next
